...
def update_ball(ai_settings, screen, persons, balls, stats):
    """更新球的位置，并检测球和人的碰撞"""
    # 更新球的位置
    balls.update()
    ...
    check_ball_bottom(balls, ai_settings, screen, stats)
...
def check_ball_bottom(balls, ai_settings, screen, stats):
    """检测球是否超出屏幕底部，若超出则重新生成一个球，并且剩余球数减一"""
