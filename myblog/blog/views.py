...
def archives(request, year, month):
    """显示归档的文章"""
    articles_list = Article.objects.filter(created_time__year=year, created_time__month=month)
...
def category(request, pk):
    ...
    articles_list = Article.objects.filter(category=cate)
    context = {'articles_list': articles_list}
    return render(request, 'blog/index.html', context=context)
...
class IndexView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        例如 render(request, 'blog/index.html', context={'articles_list': articles_list})
        这里传递了一个 {'articles_list': articles_list} 字典给模板。
